...
public class CointossGame extends Game {
	...
	private void printInstructions() {
		System.out.println(
				"Ok ok, so it couldn't be simpler, you have two options, put your points down on one and roll the dice! .... or flip a coin I guess...");
	}
